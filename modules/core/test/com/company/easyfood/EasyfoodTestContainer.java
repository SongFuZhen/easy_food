...
public class EasyfoodTestContainer extends TestContainer {

    public EasyfoodTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/easyfood/app.properties",
    ...
    public static class Common extends EasyfoodTestContainer {

        public static final EasyfoodTestContainer.Common INSTANCE = new EasyfoodTestContainer.Common();
